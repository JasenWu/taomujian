...
<table width="100%"  border="1" style="border:#6298E1 tthin solid;" cellpadding="3" cellspacing="1" class="input">
  <form name="editForm" method="post" action="PicEdit1.php?Action=SaveEdit&Result=<?php echo $Result ?>&ID=<?php echo $ID ?>"  onSubmit="return check_add();" >
    <tr>
      <td height="24" nowrap ><table width="100%" border="0" cellpadding="0" cellspacing="0"   idth="100%">
          ...
          <tr>
            <td height="20" align="right">资质名称(中)：</td>
          ...
          <tr>
            <td height="20" align="right">资质名称(英)：</td>
          ...
          <tr>
            <td height="20" align="right">资质图片：</td>
          ...
          <tr>
            <td height="20" align="right">资质类型：</td>
            <td colspan="5">
...
function NewsEdit($ID){
   ...
   if($Action=="SaveEdit"){  //添加修改数据
	 ...
	 echo "<script>alert('成功编辑资质信息！');location.href='PicList1.php';</script>";
  }else{   //提取信息
     if($Result=="Modify"){
