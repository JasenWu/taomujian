...
<script language="javascript" >
 function check_add(){
    if(document.editForm.NewsNameSi.value==""){alert("请填写常见问题标题");document.editForm.NewsNameSi.focus();return false;}
	if(document.editForm.SortID.value=="2"){alert("请选择常见问题类别");return false;}
	if(document.editForm.SortID.value=="3"){alert("请选择常见问题类别");return false;}
	return true;
 }
</script>
...
<table width="100%"  border="1" style="border:#6298E1 tthin solid;" cellpadding="3" cellspacing="1" class="input">
  <form name="editForm" method="post" action="NewsEdit1.php?Action=SaveEdit&Result=<?php echo $Result ?>&ID=<?php echo $ID ?>"  onSubmit="return check_add();" >
    <tr>
      <td height="24" nowrap ><table width="100%" border="0" cellpadding="0" cellspacing="0"   idth="100%">
          ...
          <tr>
            <td height="20" align="right">常见问题名称：</td>
          ...
          <tr style="display:none;">
            <td height="20" align="right">常见问题图片：</td>
          ...
          <tr>
            <td height="20" align="right" valign="top">常见问题介绍：<br>
...
function NewsEdit($ID){
   ...
   if($Action=="SaveEdit"){  //添加修改数据
	 ...
	 echo "<script>alert('成功编辑常见问题信息！');location.href='NewsList1.php';</script>";
  }else{   //提取信息
     if($Result=="Modify"){
