...
($parentid==24 && $ID<>30)?$css='style="display:none;"':$css="";*/
$css="";$css1="";
...
<table width="90%" border="0" cellpadding="3" cellspacing="1"  class="input">
  <form name="editForm" method="post" action="AboutEdit.php?Action=SaveEdit&Result=<?php echo $Result ?>&id=<?php echo $ID ?>">
  ...
  <tr>
    <td height="24" nowrap ><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
	  ...
	  <tr <?php echo $css1?>>
        <td height="20" align="right" valign="top">中文内容：
		<td>
        
        
        <textarea name="ContentSi" rows="8" class="textfield" id="ContentSi" style="WIDTH: 86%; height:350px;"   ><?php echo @$ContentSi ?></textarea>
      ...
      <tr style="display:none;">
        <td height="20" align="right" valign="top"><strong>英文内容</strong>：
		<td>
        <textarea name="ContentEn" rows="8" class="textfield" id="ContentEn" style="WIDTH: 86%; height:350px;"   ><?php echo @$ContentEn ?></textarea>
        </td>
      </tr>
     <tr>
	    <TD colspan="2">&nbsp;</TD>
