...
//删除产品分类节点--------------------------------------------------------------
{
   ...
   {
       window.location.href=Result+".php?Action=Del&ID="+ID ;
   } 
}
//分类节点展开和折叠(备用)-------------------------------------------------------------
...
function AdminOut()
{
   ...
   location.replace("CheckAdmin.php?AdminAction=Out")
}
//跳转到第几页-------------------------------------------------------------------------------
...
function AddSort(SortNameSi,ID,Path)
{
	window.opener.editForm.SortNameSi.focus();								
	window.opener.document.editForm.SortNameSi.value=SortNameSi;
